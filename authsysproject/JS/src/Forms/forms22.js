...
const _schema = {
  ...
  properties: {
    ...
    /////////////prescription//////////////////////////
    //left minus power///////////
    OptometryPrescriptionLminusPowerType: {
      type: "string",
      enum: [
        "0",
        "-0.25",
    ...
    ////////////left plus power/////////
    OptometryPrescriptionLplusPowerType: {
      type: "string",
      enum: [
        "0",
        "+0.25",
    ...
    //right minus power
    OptometryPrescriptionRminusPowerType: {
      type: "string",
      enum: [
        "-0.25",
        "-0.50",
    ...
    //rght plus power
    OptometryPrescriptionRplusPowerType: {
      type: "string",
      enum: [
        "+0.25",
        "+0.50",
    ...
    /////////////////far///////////////////
    //left minus power////
    OptometryPrescriptionLminusPowerTypeFar: {
      type: "string",
      enum: [
        "0",
        "-0.25",
    ...
    //left plus far
    OptometryPrescriptionLplusPowerTypeFar: {
      type: "string",
      enum: [
        "0",
        "+0.25",
    ...
    //rght mnus power far///////////
    OptometryPrescriptionRminusPowerTypeFar: {
      type: "string",
      enum: [
        "-0.25",
        "-0.50",
    ...
    //right plus power far/////////////
    OptometryPrescriptionRplusPowerTypeFar: {
      type: "string",
      enum: [
        "+0.25",
        "+0.50",
              ...
              elements: [
                //left eye minus power(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye minus power(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye minus power(near)",
                          scope: "#/properties/OptometryPrescriptionLminusPowerType",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye plus power(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye plus power(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye plus power(near)",
                          scope: "#/properties/OptometryPrescriptionLplusPowerType",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye axis(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye axis(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye axis(near)",
                          scope: "#/properties/OptometryPrescriptionLAxis",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //Right eye minus power(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye minus power(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye minus power(near)",
                          scope: "#/properties/OptometryPrescriptionRminusPowerType",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //Right eye plus power(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye plus power(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye plus power(near)",
                          scope: "#/properties/OptometryPrescriptionRplusPowerType",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye axis(near)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye axis(near1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye axis(near)",
                          scope: "#/properties/OptometryPrescriptionRAxis",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye minus power(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye minus power(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye minus power(far)",
                          scope: "#/properties/OptometryPrescriptionLminusPowerTypeFar",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye plus power(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye plus power(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye plus power(far)",
                          scope: "#/properties/OptometryPrescriptionLplusPowerTypeFar",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye axis(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Left eye axis(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Left eye axis(far)",
                          scope: "#/properties/OptometryPrescriptionLAxisFar",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //Right eye minus power(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye minus power(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye minus power(far)",
                          scope: "#/properties/OptometryPrescriptionRminusPowerTypeFar",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //Right eye plus power(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye plus power(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye plus power(far)",
                          scope: "#/properties/OptometryPrescriptionRplusPowerTypeFar",
                          options: {
                            format: "radio",
                          },
                        },
                ...
                //left eye axis(far)
                {
                  ...
                  elements: [
                    {
                      type: "HorizontalLayout",
                      label: "Right eye axis(far1)",
                      elements: [
                        {
                          type: "Control",
                          label: "Right eye axis(far)",
                          scope: "#/properties/OptometryPrescriptionRAxisFar",
                          options: {
                            format: "radio",
                          },
                        },
